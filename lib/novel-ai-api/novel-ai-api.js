import { Unpackr, addExtension } from "lib/msgpackr/index.min.js";
...
export function NovelAiApi(accessToken = null, encryptionKey = null) {
    ...
    msgpackr.addExtension({ type: 20, read: extReadPassthrough });
    msgpackr.addExtension({ type: 30, read: extReadPassthrough });
    msgpackr.addExtension({ type: 31, read: extReadPassthrough });
    msgpackr.addExtension({ type: 40, read: extReadPassthrough });
    msgpackr.addExtension({ type: 41, read: extReadPassthrough });
