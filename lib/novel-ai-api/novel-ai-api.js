...
import "../pako/pako_inflate.js"

export const API_NOVELAI = 'https://api.novelai.net';
export const IMAGE_NOVELAI = 'https://image.novelai.net';
...
export function NovelAiApi(accessToken = null, encryptionKey = null) {
    ...
    function setApiEndpoint(uri) {
        uriEndpoint = uri;
    }

    function setAuthHeader(headerName) {
    ...
    async function populateKeyStore(accessToken, encryptionKey) {
        ...
        await $.ajax({
            type: "GET",
            url: uriEndpoint + '/user/keystore',
            contentType: 'application/json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader(authHeader, "Bearer " + accessToken);
            }
        }).done(function (response) {
            try {
    ...
    async function getUserStories() {
        ...
        await $.ajax({
            type: "GET",
            url: uriEndpoint + '/user/objects/stories',
            contentType: 'application/json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader(authHeader, "Bearer " + lib.keys.accessToken);
            }
        }).done(function (data) {
    ...
    async function getUserStory(storyId) {
        ...
        await $.ajax({
            type: "GET",
            url: uriEndpoint + '/user/objects/stories/' + storyId,
            contentType: 'application/json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader(authHeader, "Bearer " + lib.keys.accessToken);
            }
    ...
    async function getUserStoryContent(storyContentId) {
        ...
        await $.ajax({
            type: "GET",
            url: uriEndpoint + '/user/objects/storycontent/' + storyContentId,
            contentType: 'application/json',
            beforeSend: function (xhr) {
                xhr.setRequestHeader(authHeader, "Bearer " + lib.keys.accessToken);
            }
